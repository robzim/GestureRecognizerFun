...
//
    ...
    [self setBackgroundColor:[UIColor colorWithRed:.8 green:.8 blue:1.0 alpha:1.0]];
//    [self makeMyLabels];
    //
    //
...
{
//    NSLog(@"up swipe!");
    SKSpriteNode *myOspreySprite = [[SKSpriteNode alloc] initWithImageNamed:@"rz egret with alpha.png"];
